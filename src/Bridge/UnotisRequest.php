<?php namespace Spoob\UnotisLaravel\Bridge;

use Spoob\UnotisLaravel\Interfaces\UnotisRequest as iRequest;


class UnotisRequest implements iRequest
{
    const USER_AGENT = 'UNOTIS-SDK/2.0 (+https://unotis.ru/documentation))';
